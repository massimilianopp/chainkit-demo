...
export const MERCHANT_WALLET = new PublicKey(process.env.MERCHANT_WALLET || "6UYpXsYihabr4LPcamqqbBKxock41AsFH12zcGPviWkY");
export const TOMATO_MINT = new PublicKey("CdczQNrp2DZ9c89LSjCyRF6VmS4VtTCBkNSjXtpvmoon");
